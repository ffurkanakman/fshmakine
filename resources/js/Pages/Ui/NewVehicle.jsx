...
const VehicleWizard = ({ breadcrumbs, title }) => {
            ...
            <Content>
                ...
                >
                    <div className="stepper-nav mb-5">
                        ...
                        >
                            <h3 className="stepper-title">Araç Bilgileri</h3>
                        </div>
                            ...
                            >
                                ...
                                >
                                    <div className="step-content row">
                                        ...
                                        <div className="col-lg-6">
                                            <label className="form-label required mt-5">
                                                Model
                                            </label>
                                            <Field
                                                type="text"
                                ...
                                <div data-kt-stepper-element="content">
                                    <div className="step-content">
                                        <h3 className="mb-5">Araç Bilgileri</h3>
                                        ...
                                        {/* Vehicle Information */}
                                        <h4 className="mt-10 mb-5">Standart</h4>
                                        <div className="row">
                                        ...
                                        <h4 className="mt-10 mb-5">Ağırlık</h4>
                                        <div className="row">
                                            <div className="col-md-6 mb-10">
                                                <label className="form-label">
                                                    Servis Ağırlığı (Pil Dahil)
                                                </label>
                                                <Field
                                                    type="text"
                                                    className="form-control w-100"
                                        ...
                                        <h4 className="mt-10 mb-5">Boyut</h4>
                                        <div className="row">
                                            <div className="col-md-6 mb-10">
                                                <label className="form-label">
                                                    Direk Kapalı Yüksekliği
                                                </label>
                                                <Field
                                                    type="text"
                                                    className="form-control w-100"
                                        ...
                                        <h4 className="mt-10 mb-5">Sürüş</h4>
                                        <div className="row">
                                            <div className="col-md-6 mb-10">
                                                <label className="form-label">
                                                    Sürüş Motoru (S2-60min)
                                                </label>
                                                <Field
                                                    type="text"
                                                    className="form-control w-100"
